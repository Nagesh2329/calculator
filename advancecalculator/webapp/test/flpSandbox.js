		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "mobile",
									"targetURL": "#calculatoradvancecalculator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"calculatoradvancecalculator-display": {
								"semanticObject": "calculatoradvancecalculator",
								"action": "display",
								"description": "this look like a mobile calculator",
								"title": "mobile",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=calculator.advancecalculator",
									"url": sap.ui.require.toUrl("calculator/advancecalculator")
								}
							}
						}
					}
