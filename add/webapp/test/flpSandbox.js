		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "addsubmulti",
									"targetURL": "#addsubmultiadd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"addsubmultiadd-display": {
								"semanticObject": "addsubmultiadd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=addsubmulti.add",
									"url": sap.ui.require.toUrl("addsubmulti/add")
								}
							}
						}
					}
