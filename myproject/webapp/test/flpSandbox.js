		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "hello",
									"targetURL": "#hellomyproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hellomyproject-display": {
								"semanticObject": "hellomyproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hello.myproject",
									"url": sap.ui.require.toUrl("hello/myproject")
								}
							}
						}
					}
